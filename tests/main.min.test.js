...
const getTestTitle = ( util, obj ) => 'Check Truth Table:  * ' + util + ' *  ' + spaces(13 - util.length) +
                                      obj + ': ' + spaces(19 - obj.length) + 
                                      truthTable[util][obj] + spaces(9 - getLength( truthTable[util][obj] ))
